...
if __package__ in (None, ""):
    ...
    from rstControllers.rstTool.design import poly_to_str, diff_eq_strings
else:
...
def main() -> None:
    p = argparse.ArgumentParser(
        prog="rstControllers.rstTool",
        description="RST design & simulation (q=z^{-1}), outputs → rstControllers/rstTool/out/",
    ...
    # I/O
    p.add_argument("--in_json", help="Load spec JSON (looked up under rstControllers/rstTool/in by default)")
