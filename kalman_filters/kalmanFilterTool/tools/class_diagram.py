...
Usage
-----
Inside kalman_filters/kalmanFilterTool/:
    python tools/class_diagram.py --out out

From project root:
    python -m kalman_filters.kalmanFilterTool.tools.class_diagram --out kalman_filters/kalmanFilterTool/out
"""
...
title kalman_filters.kalmanFilterTool — Class Diagram

package kalman_filters.kalmanFilterTool {
  class KalmanModel { }
  class Simulator { }
