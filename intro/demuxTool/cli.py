...
if __package__ in (None, ""):
    ...
    from intro.demuxTool.apis import RunRequest
    from intro.demuxTool.app import DemuxApp
else:
    from .apis import RunRequest
    from .app import DemuxApp

def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="intro.demuxTool — N-way demultiplexer (PyRTL)")
