...
Supports:
- python -m zTransform.zTransformTool.cli
- python zTransform/zTransformTool/cli.py  (import shim below)
"""
import argparse
import os
import sys
...
if __package__ in (None, ""):
    ...
    from zTransform.zTransformTool.apis import RunRequest
    from zTransform.zTransformTool.app import ZTApp
else:
