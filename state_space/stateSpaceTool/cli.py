...
def main():
    ap = argparse.ArgumentParser(description="state_space.stateSpaceTool - Canonical realizations (discrete SISO).")
    ...
    if not args.quiet:
        ...
        from state_space.stateSpaceTool.design import pretty_tf_lines, pretty_ss_lines
