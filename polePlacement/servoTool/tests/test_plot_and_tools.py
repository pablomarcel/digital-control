...
def test_class_diagram_writes():
    from polePlacement.servoTool.tools.class_diagram import main
    main(out_dir="out")
    # file path
...
def test_plot_matplotlib(tmp_path):
    from polePlacement.servoTool.plot import plot_matplotlib
    y = [0, 0.5, 0.8, 1.0]
...
def test_plot_plotly(tmp_path):
    from polePlacement.servoTool.plot import plot_plotly
    y = [0, 0.5, 0.8, 1.0]
