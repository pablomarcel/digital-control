...
def test_cli_help_runs():
    ...
    candidates = [
        ...
        here.parents[2] / "zGridTool" / "cli.py",               # .../system_design/zGridTool/cli.py
        here.parents[2] / "system_design" / "zGridTool" / "cli.py",
        here.parents[3] / "system_design" / "zGridTool" / "cli.py",
    ]
    ...
    if cli is None:
        ...
        raise AssertionError(
            ...
            "\nFATAL: Could not locate system_design/zGridTool/cli.py\n"
        )

    # Run from inside the package dir so the import shim in cli.py works
    pkg_dir = cli.parent

    # Build PYTHONPATH to include the project root (…/system_design/..)
