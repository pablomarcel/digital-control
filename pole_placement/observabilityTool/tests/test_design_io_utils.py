...
from pole_placement.observabilityTool.design import capture_pretty_text
from pole_placement.observabilityTool.io import parse_matrix_string, load_from_json, save_json
...
def test_io_parse_and_json(tmp_path):
    ...
    from pole_placement.observabilityTool.io import load_from_json
