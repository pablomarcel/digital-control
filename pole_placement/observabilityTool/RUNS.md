...
python cli.py \
  ...
  --C "1 5" \
  --discrete \
  --pretty --pbh --save-csv --name ex6_3_case1_obs
```
...
python cli.py \
  ...
  --C "4 5 1" \
  --discrete \
  --pretty --pbh --gram --name ex6_4_unobs
```
...
python cli.py \
  --A "0 1; -1 0" \
  --C "1 0" \
  --finite-ct 5.0 --pretty --name ct_finite
```
