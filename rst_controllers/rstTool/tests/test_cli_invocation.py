...
import os, sys, shlex
from rst_controllers.rstTool import cli
...
def test_cli_main_pretty(capsys, monkeypatch):
    ...
    assert os.path.exists(os.path.join("rst_controllers","rstTool","out","rst.csv"))
    assert os.path.exists(os.path.join("rst_controllers","rstTool","out","rst_design.json"))
