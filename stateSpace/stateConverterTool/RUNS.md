...
>
> ```bash
> cd stateSpace/stateConverterTool
> ```
...
### Quick
```bash
pytest stateSpace/stateConverterTool/tests -q
```

### With coverage report
```bash
pytest stateSpace/stateConverterTool/tests --override-ini addopts= --cov --cov-config=stateSpace/stateConverterTool/.coveragerc --cov-report=term-missing
```
